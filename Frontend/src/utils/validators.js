// Mirrors Backend/src/utils/validators.js so "a valid email" means the same
// thing on both sides — this gives instant feedback before a round trip, the
// backend re-checks the same rules regardless. (Phone numbers: utils/phone.js.)
