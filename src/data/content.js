...
// ============================================================
export const legal = {
  updated: "Effective date: June 2026 · Last updated: June 2026",
  privacy: {
    intro:
...
• Use our platform for any unlawful or harmful purpose`,
      ...
      {
        title: "9. Placement Assistance Disclaimer",
...
• Actions taken by third-party platforms we integrate with (e.g., email or payment providers)
...
Our total liability in any matter shall not exceed the amount you paid for our services.`,
      ...
      },
      {
        ...
        content: `We reserve the right to terminate or suspend access to our services at our discretion for conduct that we believe violates these Terms or is harmful to other users, us, or third parties. Upon termination, your right to use our services immediately ceases.`,
      },
      {
...
Location: Ahmedabad, Gujarat, India`,
  ...
  clientTerms: {
    ...
    sections: [
      ...
      {
        title: "3. Fees & Taxes",
        content: `Fees for the Services are as set out in the applicable proposal/SOW and are exclusive of any taxes that may apply, unless stated otherwise. Advance payment and milestone/payment schedules are specified in the SOW. All fees paid are non-refundable except as expressly stated in the applicable SOW or as required by applicable law.`,
      },
      {
